            ...
            <div class="columns">
                ...
                $children = wp_list_pages( 
                    ...
                    <?php if ($children) { ?>
                        ...
                        ?>
                        <div class="sidebar-header"><?php the_title(); ?></div>
                        ...
                        <p class="sidebar-more"><a href="<?php echo $parent_link; ?>" title="All <?php echo $parent_title; ?> Practice Areas"><?php echo $parent_title; ?> Practice Areas</a> <span class="icon-tick-down"></span></p>

                    <?php } else { ?>
                         
                        <div class="sidebar-header">All Practice Areas</div>
                        <div class="sidebar-menu">
        ...
        <div class="container">
            <div class="columns">
                <div class="column-50 block">
                    <p class="testimonial-callout"><em><?php the_field('testimonial_callout','options'); ?></em></p>
                </div>
                <div class="column-50 block">
